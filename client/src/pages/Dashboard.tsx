...
const INITIAL_TASKS: Task[] = [
  {
    id: 1,
    title: 'Implement Security Config',
    description: 'Setup Spring Security CORS and permit endpoints',
    status: 'IN_PROGRESS',
    priority: 'HIGH',
    ownerEmail: 'owner@devboard.com',
    assignedEmails: ['dev1@devboard.com', 'dev2@devboard.com', 'lead@devboard.com'],
  ...
  },
  {
    ...
    description: 'Configure Neon DB connection string and Hikari pool',
    status: 'DONE',
    priority: 'MEDIUM',
    ownerEmail: 'owner@devboard.com',
    assignedEmails: ['lead@devboard.com'],
    startDate: '2026-08-01',
    dueDate: '2026-08-05'
  },
  {
    id: 3,
    title: 'Design Task Controller',
    description: 'Add CRUD endpoints for tasks and assignees',
    status: 'TODO',
    priority: 'LOW',
    ownerEmail: 'owner@devboard.com',
    assignedEmails: ['qa@devboard.com', 'frontend@devboard.com'],
...
export default function Dashboard() {
  ...
  const CURRENT_USER_EMAIL = 'owner@devboard.com'
  ...
  const fetchTasks = async () => {
    try {
      ...
      if (res.ok) {
        ...
        toast.error(resBody.error || "Failed to fetch task")
      }
  ...
  const handleDelete = async(id:number)=>{
    try {
      ...
      if(res.ok){
        ...
        toast.error(resBody.error || "Task not deleted")
      }
