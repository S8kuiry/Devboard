...
import PlanCardComponent from './agenticModal/PlanCardComponent'
                          ...
                          <div key={i} className="space-y-1">
                            <div className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                              ...
                              >
                                ...
                                {/* 1b. Dynamic Plan Cards */}
                                {msg.role === 'assistant' && msg.data_type === 'PLAN_LIST' && Array.isArray(msg.data) && (
                                  <div className="mt-2 space-y-2 w-auto">
                                    {msg.data.map((plan: Plan) => (
                                      <PlanCardComponent
                                        key={plan.id}
                                        plan={plan}
